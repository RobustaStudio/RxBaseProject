...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of RxBaseProject.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ahmed93/RxBaseProject'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ahmed93' => 'ahmed.moh.magdi93@gmail.com' }
  s.source           = { :git => 'https://github.com/ahmed93/RxBaseProject.git', :tag => s.version.to_s }
